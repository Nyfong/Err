                    ...
                    <div class="card-body">
                        <form>
                            ...
                            <div class="mb-3">
                                ...
                                <input class="form-control" id="inputNotificationSms" type="tel" value="+855-------" disabled="">
                            </div>
                    ...
                    <div class="card-body">
                        <form>
                            ...
                            <div class="form-check mb-2">
                                ...
                                <label class="form-check-label" for="checkAutoGroup">Automatically subscribe to favorite products notifications</label>
                            </div>

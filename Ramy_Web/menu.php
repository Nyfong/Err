...
=======
        <li data-filter=".Earing">Earring</li>
        <li data-filter=".Skirt">Skirt</li>
        <li data-filter=".Watch">Watch</li>
        <li data-filter=".Necklace">Necklace</li>
        <li data-filter=".Braclet">Bracelet</li>
        <li data-filter=".Ring">Ring</li>
>>>>>>> Stashed changes
      </ul>
...
=======
          <div class="col-sm-6 col-lg-4 all Earring">
>>>>>>> Stashed changes
            <div class="box">
              <div>
                <div class="img-box">
                  <img src="<?= $TagenameProductTwo['earing'] ?>" alt="Earring">
                </div>
                <div class="detail-box">
                  ...
                  <p>
                  Samput Soth is a kind of skirt that Cambodian woman used it in some ceremonies or at home. It will be shown that we are from Cambodian whenever we used it. It has made since ancient.
                  </p>
                  <div class="options">
                    <h6>
                      10000 (Real)
...
=======
          ...
          <div class="col-sm-6 col-lg-4 all kuy_teav">
            <div class="box">
              <div>
                <div class="img-box">
                  <img src="<?= $TagenameProductTwo['Skrit']; ?>" alt="kuy teav">
                </div>
                <div class="detail-box">
                  <h5>
                   hello
          ...
          <div class="col-sm-6 col-lg-4 all Nomb_banh_chok">
            <div class="box">
              <div>
                <div class="img-box">
                  <img src=" <?=  $err = $TagenameProduct['watch']; ?>" style="object-fit: cover;" alt="Nom banh Chok" >
                </div>
                <div class="detail-box">
                  <h5>
                    Nom Banh Chok
          ...
          <div class="col-sm-6 col-lg-4 all Amok">
            <div class="box">
              <div>
                <div class="img-box">
                  <img src="<?= $TagenameProduct['Card']; ?>" alt="fish Amok">
                </div>
                <div class="detail-box">
                  <h5>
                    Fish Amok
          ...
          <div class="col-sm-6 col-lg-4 all kam-pisa-chien">
            <div class="box">
              <div>
                <div class="img-box">
                  <img src="<?= $TagenameProductTwo['nekless']; ?>" alt="Kam-Pisa-Chien">
                </div>
                <div class="detail-box">
                  <h5->
                    Kam Pisa chien
          ...
          <div class="col-sm-6 col-lg-4 all banh-chev">
            <div class="box">
              <div>
                <div class="img-box">
                  <img src="<?= $TagenameProduct['boom']; ?>" alt="banh-chev-crepes-khmer">
                </div>
                <div class="detail-box">
                  <h5>
                  Banh Chev
          ...
          <div class="col-sm-6 col-lg-4 all lort-Cha">
            <div class="box">
              <div>
                <div class="img-box">
                  <img src="<?= $TagenameProductTwo['ring'];?>" alt="lort cha">
                </div>
                <div class="detail-box">
                  <h5>
                    Lord cha
